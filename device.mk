...
VENDOR_BLOBS ?= device/CUBOT/KING_KONG/vendor/KING_KONG-vendor.mk
...
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_UTC_DATE=6

# Inherit the rest from mt6580-common
$(call inherit-product, device/CUBOT/KING_KONG/mt6580-common/mt6580.mk)
